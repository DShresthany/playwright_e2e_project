# QADemo original README (archived)

> **Archive only.** This is the upstream-style QADemo README from before the portfolio rewrite
> (`de9cdbe`). Kept for reference (setup, practice scenarios, API/deploy notes).
>
> Portfolio overview: **[README.md](../README.md)** · E2E runbook: **[E2E.md](./E2E.md)**
...
**Playwright E2E:** [Run tests locally & CI overview](./E2E.md) — full suite runs on every PR to `main`.
